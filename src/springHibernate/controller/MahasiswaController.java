...
public class MahasiswaController {
    ...
    public void saveMahasiswa() {
        ...
        mahasiswa.setNPM(this.mahasiswaView.setNPM().getText());
        mahasiswa.setNama(this.mahasiswaView.setNama().getText());
        mahasiswa.setKelas(this.mahasiswaView.setKelas().getText());
        mahasiswa.setAlamat(this.mahasiswaView.setAlamat().getText());
